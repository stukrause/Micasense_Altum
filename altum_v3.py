# This script is a variation originally from https://github.com/mdanilevicz/multispectral_img
# based off the workflow from https://github.com/micasense/imageprocessing
